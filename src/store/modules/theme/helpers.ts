...
export function getLocalThemeSettings() {
  return (
    localStg.get("themeSettings") || {
      darkMode: false,
      naiveOverrides: {
        common: {
          primaryColor: "#FF7206FF",
          successColor: "#52c41a",
          errorColor: "#F5222DFF",
          warning: "#f0a020",
          info: "#2080F0FF",
          //hover
          primaryColorHover: getColorPalette("#292d3e", 2),
          primaryColorPressed: getColorPalette("#292d3e", 4)
        }
      },
      layout: {
        mode: EnumThemeLayoutMode.vertical
      },
      page: {}
    }
  )
